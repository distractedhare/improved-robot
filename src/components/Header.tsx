  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        {/* Top row — Logo + Mode toggle + New Call */}
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            {/* 3-state theme toggle — hidden on small screens, visible sm+ */}
            <div
              className="hidden sm:flex rounded-full p-0.5 gap-0.5"
              style={{
            ...
            >
              {([
                ...
                <button
                  ...
                  className="focus-ring flex items-center gap-1 text-[9px] font-extrabold uppercase tracking-wider px-2 sm:px-2.5 py-1.5 rounded-full transition-all"
                  style={{
                ...
                >
                  ...
                  <span className="xs:hidden">{m.label.slice(0, 1)}</span>
            ...
            <button
              ...
              className="focus-ring flex items-center gap-1.5 text-[10px] font-extrabold px-2.5 sm:px-4 py-2 rounded-full transition-all uppercase tracking-widest"
              style={{
        ...
        {/* Mobile-only theme row — only shows on small screens */}
          ...
          >
            {([
              ...
              <button
                ...
                aria-label={t.label}
                aria-pressed={themePreference === t.id}
                className="focus-ring flex items-center gap-1 px-2.5 py-1 rounded-full transition-all text-[8px] font-bold uppercase tracking-wider"
                style={{
                  background: themePreference === t.id
                    ? 'linear-gradient(135deg, #E20074, #C70066)'
                    : 'transparent',
