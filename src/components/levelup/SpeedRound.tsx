      ...
      <div className="space-y-5">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm font-medium text-t-dark-gray">
            {ROUND_SIZE} questions. 90 seconds. Fast enough to feel fun, sharp enough to help the next live call.
          </p>
        </div>
        ...
        <div className="glass-card rounded-xl p-4">
          ...
          <ul className="mt-2 space-y-1.5 text-xs font-medium text-t-dark-gray">
            ...
            <li className="flex items-start gap-2">
              <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-t-magenta" />
              Use the explanations as coaching, not just scoring
            </li>
          </ul>
        </div>
    ...
    <div className="space-y-5">
        ...
        <p className="mt-1 text-sm font-medium text-t-dark-gray">
          {earnedMomentum
            ...
            : `${finalScore}% — you need 70% for the badge. Tighten the misses, then run it back.`}
        </p>
      </div>
      ...
      {answers.some((a) => !a.correct) && (
        <div className="space-y-2">
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-t-dark-gray">What to clean up</p>
